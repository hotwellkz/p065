...
export async function fetchChannelSchedule(): Promise<ChannelScheduleItem[]> {
  ...
  const response = await fetch(`${API_BASE_URL}/api/channels/schedule`, {
    method: "GET",
    headers: {
...
export async function updateChannelSchedule(
  ...
  const response = await fetch(`${API_BASE_URL}/api/channels/${channelId}/schedule`, {
    method: "PATCH",
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`
...
export async function updateChannelAutomation(
  ...
  const response = await fetch(`${API_BASE_URL}/api/channels/${channelId}/automation`, {
    method: "PATCH",
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`
